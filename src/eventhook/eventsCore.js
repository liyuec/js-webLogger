...
var _isOriginalEventTarget = (function () {
  return window.EventTarget.toString().includes(
    "EventTarget() { [native code] }"
  );
})();
 ...
 */
function rewWriteAddEventListener(
  EventTypes = ["click"],
  beforeFuncList = void 0,
  beforeFuncList = void 0
) {
...
export {rewWriteAddEventListener, reWriteRemoveEventListsner};
